...
public class TextViewVertical extends View {
    ...
    public final void setText(String text) {
        Log.v("TextViewVertical", "setText");
        if (text != null) {
            this.text = text;
    ...
    public final void setTextSize(float size) {
        Log.v("TextViewVertical", "setTextSize");
    ...
    public final void setTextColor(int color) {
        ...
        Log.v("TextViewVertical", "setTextColor");
    }
    ...
    public void setTypeface(Typeface tf) {
        Log.v("TextViewVertical", "setTypeface");
    ...
    private void GetTextInfo() {
        ...
        Log.v("TextViewVertical", "mLineWidth = " + mLineWidth);
        FontMetrics fm = paint.getFontMetrics();
       // mFontHeight = (int) (Math.ceil(fm.descent - fm.top) * 0.9);// 获得字体高度
        mFontHeight = (int) (Math.ceil(fm.descent - fm.top));// 获得字体高度
        Log.v("TextViewVertical", "mFontHeight = " + mFontHeight);
        Log.v("TextViewVertical", "TextLength = " + TextLength);
        Log.v("TextViewVertical", "mTextHeight = " + mTextHeight);
        //计算文字行数
        mRealLine = 0;
        for (int i = 0; i < this.TextLength; i++) {
        ...
        mRealLine++;//额外增加一行
        Log.v("TextViewVertical", "mRealLine = " + mRealLine);
        mTextWidth = mLineWidth * mRealLine;//计算文字总宽度
        Log.v("TextViewVertical", "mTextWidth = " + mTextWidth);
        measure(mTextWidth, getHeight());//重新调整大小
        Log.v("TextViewVertical", "measure");
        layout(getLeft(), getTop(), getLeft() + mTextWidth, getBottom());//重新绘制容器
        Log.v("TextViewVertical", "layout");
    }

    @Override
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        Log.v("TextViewVertical", "onMeasure");
    ...
    private int measureHeight(int measureSpec) {
        ...
        Log.v("TextViewVertical", "measureHeight = " + specSize);
        int result = 435;
